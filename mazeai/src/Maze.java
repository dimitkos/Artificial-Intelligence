 ...
 *
 * Sto plaisio tou mathimatos texniti noimosini tou kathgiti kiriou Themistokli Panagiotopoulo xrisimopiisame ton kodika
 * tou kiriou Nikou Kanargia, o opoios tropopiithike simfona m etis anagkes tis ergasias mas
 *
 *
 *
 *
...
public class Maze {
    ...
    public static void main(String[] args) {
        int width  = 693;
        int height = 545;
        //Dimiurgia neas formas i opia klironomite apo tni klasi jd frame me titlo artificial inteligence
        mazeFrame = new JFrame("Αrtificial Ιnteligence");
        //stin forma mazeframe ensomatonete to mazepanel me standar mege8os ke ipsos
        mazeFrame.setContentPane(new MazePanel(width,height));
        //parametropiisi tou frame etsi oste ta andikimena tou na exun to prokathorismeno megethos , i megalitero
        mazeFrame.pack();
        //den dinete ston xristi i dinatotita tropopiisis tis formas os pros tis diastasis tis
        mazeFrame.setResizable(false);
        // the form is located in the center of the screen
        mazeFrame.setLocationRelativeTo(null);
        //patondas to X pano deksia sti forma klini i efarmogi
        mazeFrame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        //ginete i forma orati
     ...
     */
    //dimiurgia statikis klasis maze panel i opia klironomite apo tin klasi Jpanel
    public static class MazePanel extends JPanel {
        ...
        //Esoteriki klasi pou dimiurgei ton lavirintho
        private class MyMaze {
            ...
            // constructor - arxikopiume tis thesis ton embodion simfona me to project
            public MyMaze() {
                grid[4][1] = OBST;
                grid[4][2] = OBST;
                grid[3][2] = OBST;
            ...
            private void init() {
                // Dimiurgia ton kelion tou pinaka
            ...
            // Esoteriki klasi gia tin anaparastasi enos keliu
            private class Cell {
                int x, y; // coordinates
         ...
         */
        //Klasi pou diaxirizete tis energies tou pondikiou ilopiondas 2 interface
        private class MouseHandler implements MouseListener, MouseMotionListener {
            private int cur_row, cur_col, cur_val;
            @Override
            //Sira energion stin periptosi pou o xristis epileksi kati me ton kersora
            public void mousePressed(MouseEvent evt) {
                ...
                if (row >= 0 && row < rows && col >= 0 && col < columns) {
                    if (realTime ? true : !found && !searching){
                        ...
                        //Aferethike apo ton xristi i dinatotita na alaksi tin katastasi mias thesis apo diathesimi se embodio
                        //if (cur_val == EMPTY)
                        //    grid[row][col] = OBST;
                        //if (cur_val == OBST)
                        //    grid[row][col] = EMPTY;
            ...
            @Override
            //O xristis den bori pleon na metakinisi tin arxiki thesi tu robot ke tin thesi termatismu
            ...
            //methodoi pou den exun soma kai ilopiisi , ostoso einai aparetiti i iparksi tous logo ton interface
            @Override
        ...
        int rows    = 5,           // the number of rows of the grid
                columns = 5,           // the number of columns of the grid
        ...
        //Constractoras me dio orizmata, gia to platos ke to ipsos gia to panel tou lavirinthou
        public MazePanel(int width, int height) {

            super.setLayout(null);
            //ftiaxnume ena andikimeno listener tipou MouseHandler kai stin sinexia to sindeoume
            ...
            //Alaksame tin timi tou maximum kathos ke tou value se 5 etsi oste o pinakas na metatrapi se 5x5 stin arxiki tou morfi
            ...
            mazeButton.setToolTipText
                    ("Creates a maze according to our project");
            ...
            //Isagogi label gia tin epilogi ton time-intervals
            JLabel delayLbl = new JLabel("Delay (0-1000 msec)", JLabel.CENTER);
            //Orizmos gramatosiras tis etiketas
            delayLbl.setFont(new Font("Helvetica",Font.PLAIN,10));

            //Ftiaxnume tin bara gia ton orismo ton time-intervals
            ...
            //Dimiurgume ena andikimeno algogroup sto opio vazume ta radio-buttons gia tus adistixus algorithmus
            ...
            //Dimiurgume ena panel tipou Jpanel, meso tis setborder diamorfonume mia diataksi gia ta kubia
        ...
        private void initializeGrid(Boolean makeMaze) {
            ...
            grid = new int[rows][columns];
            robotStart = new Cell(rows-2,0);
            targetPos = new Cell(3,columns-2);
            fillGrid();
            //if (makeMaze) {
        ...
        private void fillGrid() {
            ...
            if (searching || endOfSearch){
                ...
                for (int r = 0; r < rows; r++)
                    for (int c = 0; c < columns; c++)
                        grid[r][c] = EMPTY;
                //Alaksame tin arxiki thesi tou robot
                robotStart = new Cell(rows-2,0);
                //Alaksame tin thesi tou termatismu
                targetPos = new Cell(3,columns-2);
            }
        ...
        private void clearButtonActionPerformed(java.awt.event.ActionEvent evt) {
            ...
            enableRadiosAndChecks();
            fillGrid();
            //Prosthiki ton prokathorismenon embodion ston kodika, etsi oste na emfanistun ksana meta tin xrisi tou clear
            grid[4][1] = OBST;
            grid[4][2] = OBST;
            grid[3][2] = OBST;
            grid[2][2] = OBST;
